...
class BookMarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_mark" do
    assert_difference('BookMark.count') do
      post book_marks_url, params: { book_mark: { title: @book_mark.title, url: @book_mark.url } }
    end
  ...
  test "should update book_mark" do
    patch book_mark_url(@book_mark), params: { book_mark: { title: @book_mark.title, url: @book_mark.url } }
